...
> This is the canonical reference artifact for `covenant.md`. Copy it into a workspace, adapt it together, and ratify it there. Until the human and agent affirm it, it is a model for a covenant rather than their covenant.
